  ...
  async function updatePastEvent(data: PastEventSubmitPayload) {
    ...
    const { error } = await serverSupabase
      ...
      .upsert({
        ...
        date: data.date || event.date || new Date().toISOString(),
        location: data.location || event.location || "",
        attendanceCount: data.attendanceCount !== undefined ? data.attendanceCount : event.attendanceCount,
        coverImageUrl: data.coverImageUrl !== undefined ? data.coverImageUrl : event.coverImageUrl,
        galleryUrls: data.galleryUrls || [],
        highlights: data.highlights || event.highlights || [],
        keyTakeaways: data.keyTakeaways || event.keyTakeaways || [],
        speakers: data.speakers || event.speakers || [],
        partnerName: data.partnerName !== undefined ? data.partnerName : event.partnerName,
        testimonial: data.testimonial !== undefined ? data.testimonial : event.testimonial,
        testimonialAuthor: data.testimonialAuthor !== undefined ? data.testimonialAuthor : event.testimonialAuthor,
        status: data.status,
